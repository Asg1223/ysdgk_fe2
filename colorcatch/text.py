...
JA = {
    ...
    "grab_now": "つかめ！",
    "calib_step1": "① 色あわせ：枠にマーカー（手袋）を入れてボタン",
    "calib_step2": "② パーの形にして、手を大きく写してボタン",
    "calib_step3": "③ グー（握った形）にしてボタン",
...
EN = {
    ...
    "grab_now": "GRAB!",
    "calib_step1": "1) COLOR: put the glove in the box and press",
    "calib_step2": "2) OPEN HAND: show your open hand and press",
    "calib_step3": "3) CLOSED FIST: make a fist and press",
